...
format:
  html:
    theme: journal   # cosmo bootswatch theme
    code-fold: true
date: "2024-04-22"
...
This worked example below was motivated by [reading this paper](https://statisticalhorizons.com/wp-content/uploads/MissingDataByML.pdf) that has an interesting worked example on 'missing data and mixed models' that I thought could benefit from some figures to aid in the understanding of what is achieved.
...
(p1 + labs(title = "Erroneous model")) / (p1 + labs(title = "Mixed effects model"))
```
