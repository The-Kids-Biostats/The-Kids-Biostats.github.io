...
- Ease of changing presented statistics
-- Formatting, order, number of decimal places

- Ability to make inline adjustments (manual edits)

- Rendering across different outputs (html, pdf, word)
-- Specifically, output format and presentation
...
Additional use for model output to minimise the number of necessary packages. Next post!
